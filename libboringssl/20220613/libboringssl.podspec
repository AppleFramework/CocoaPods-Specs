Pod::Spec.new do |spec|
  ...
  spec.source       = { :http => "https://github.com/AppleFramework/boringssl/releases/download/fips-20220613/libboringssl.xcframework.zip" }

  spec.vendored_frameworks = "libboringssl.xcframework"
end
